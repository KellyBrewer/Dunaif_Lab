...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
input_file <- "J:/endocrinology/Dunaif_Train/Clustering/data/SampleData_355.txt"
...
#write.csv(m.df, "J:/endocrinology/Dunaif_Team/Dunaif_Lab/Subtyping/Clustering/8 traits- Hierarchical/output/m.df.csv")
```
...
clus.SHBG.avg <- clusters %>%
  group_by(cluster_id) %>%
  summarise(SHBG = mean(SHBG))
rep <- which.max(clus.SHBG.avg$SHBG)
...
colnames(tab) <- c('Metabolic', 'Reproductive', 'Background')
...
clusters$group <- ifelse(clusters$cluster_id==1, "Metabolic", ifelse(clusters$cluster_id==2, "Reproductive", "Background"))
...
print(clusters_summary_table,
      ...
      cnames = c("Metabolic", "Reproductive", "Background"))
```
...
bac.df <- clust.df[clust.df$cluster_id == 3,]
...
datatable(proc_means(bac.df, vars = "T", by = "T_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "shbg", by = "shbg_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "shbg", by = "shbg_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "dheas", by = "dheas_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "dheas", by = "dheas_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "lh", by = "lh_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "lh", by = "lh_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "fsh", by = "fsh_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "fsh", by = "fsh_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "i0", by = "i0_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "i0", by = "i0_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
datatable(proc_means(rep.df, vars = "g0", by = "g0_assay_method", 
          ...
          options = list(dom = 't', 
                         columnDefs = list(list(className = 'dt-center', targets = "_all"))),
          caption = "Reproductive")
datatable(proc_means(bac.df, vars = "g0", by = "g0_assay_method", 
                     n=TRUE, nmiss = TRUE, mean=TRUE,  
                     sd = TRUE, min = TRUE, max = TRUE, 
                     median = TRUE, q1 = TRUE, q3 = TRUE), 
          rownames = FALSE, 
...
```{r write_cluster_groups, echo=FALSE}

     #                   Write Out Results Files                   ~~~
     #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

write.csv(clusters, "path/to/output/cluster_result.csv")
