...
input_file <- "path/to/input/text/file/SampleData_355.txt"
...
set.seed(123)
km.res <- stats::kmeans(dist(cluster_matrix, method=dist_metric), 3, nstart = 100) #uses manhattan distance, otherwise Kmeans defaults to Euclidean
...
m.df_gmm <- m.df2[3:10]
gmm <- GMM(m.df_gmm, 3, dist_mode = "maha_dist", seed_mode = "random_subset", km_iter =10, em_iter = 100, verbose =F, seed=123) 
